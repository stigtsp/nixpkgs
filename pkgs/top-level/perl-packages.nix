  ...
  */
  ...
  AlgorithmCheckDigits = buildPerlModule {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-DySHqP0fMbGcUbJlCELyJkwed9liSHoTtSG74GbEtLw=";
    };
  ...
  AlienBuild = buildPerlPackage {
    ...
    version = "2.48";
    src = fetchurl {
      url = "mirror://cpan/authors/id/P/PL/PLICEASE/Alien-Build-2.48.tar.gz";
      sha256 = "sha256-OybkeU+DxoHz7/j50FK6dCYsHKW60wR3pB5mumQ5FpY=";
    };
  ...
  ApacheAuthCookie = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-ByhnLrmLzWZSWWenXXxNYXwLTEEWIBOsmkzv5G99/3w=";
    };
  ...
  ApacheTest = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-qZmfAqeBpYkhi1ibGHnBHEladFrwlXXly7It/LZWgKw=";
    };
    doCheck = false;
    meta = {
  ...
  AppCLI = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-Ur1D9VWRPML/1kBfmVHSqr1Gr2PXAdm140amMycJ8M4=";
    };
  ...
  Appcpm = buildPerlModule {
    ...
    version = "0.997009";
    src = fetchurl {
      url = "mirror://cpan/authors/id/S/SK/SKAJI/App-cpm-0.997009.tar.gz";
      sha256 = "sha256-eyJ5Wk7IZur4HbtmtosE30iBz8pPTw+CRYnzCDueVaY=";
    };
    buildInputs = [ ModuleBuildTiny ];
  ...
  Appperlbrew = buildPerlModule {
    ...
    version = "0.94";
    src = fetchurl {
      url = "mirror://cpan/authors/id/G/GU/GUGOD/App-perlbrew-0.94.tar.gz";
      sha256 = "sha256-Axb2p9D5JXT1WXPtrOETAVyqjar+8Dtuk2DkdkmIxRo=";
    };
  ...
  AppSqitch = buildPerlModule {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-Agg1oTQp7/2P2hLVYnYE7PmSk3dZGPT4upzMXteW5ec=";
    };
  ...
  ArchiveExtract = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-z/zxNc0GIih9OwIVT31nFklUSfyu0DlmYhlI4l6l90I=";
    };
    meta = {
  ...
  ArchiveTar = buildPerlPackage {
    ...
    version = "2.40";
    src = fetchurl {
      url = "mirror://cpan/authors/id/B/BI/BINGOS/Archive-Tar-2.40.tar.gz";
      sha256 = "sha256-LT41fWqZT6afeynXgkZNCm4CrGYAg35UdPp3Dd68lUE=";
    };
    meta = {
  ...
  BHooksEndOfScope = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-Od8vjAB6dUZyB1+VuQeXuuvpetptlEsZemNScJyzBnE=";
    };
  ...
  BusinessISBN = buildPerlPackage {
    ...
    version = "3.007";
    src = fetchurl {
      url = "mirror://cpan/authors/id/B/BD/BDFOY/Business-ISBN-3.007.tar.gz";
      sha256 = "sha256-UMxGht0hyVN7SaIx1xcR6BTr0vGapMozG6+S/y3lzhk=";
    };
  ...
  BusinessISBNData = buildPerlPackage {
    ...
    src = fetchurl {
      url = "mirror://cpan/authors/id/B/BD/BDFOY/Business-ISBN-Data-20210112.006.tar.gz";
      sha256 = "sha256-mMLPsma1/dAWmJq6pHHZ3UwdWTxQim8B9m0YTV/ui64=";
    };
    meta = {
  ...
  CacheFastMmap = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-4Es6KNmJ7bj7lur6zcK4f57MuE8EfrLifLJqp9CMx7g=";
    };
  ...
  Cairo = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-ghlzbkAcIxHaX1FXdd5D/YfmOEtQTaNqGS8rIXZDB38=";
    };
  ...
  CarpAssertMore = buildPerlPackage {
    ...
    version = "2.0.1";
    src = fetchurl {
      url = "mirror://cpan/authors/id/P/PE/PETDANCE/Carp-Assert-More-2.0.1.tar.gz";
      sha256 = "sha256-lvqjkTgGUCcaeIaxQSPdCxRUtca/NDsjDXW1vbqCtRg=";
    };
  ...
  CatalystAuthenticationStoreLDAP = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-keW4vd/XOGYqNh6/6nPYQrO6Me1wne2xqE7DRB3O7sU=";
    };
  ...
  CatalystPluginStaticSimple = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-Wk2Fo1iM1Og/GwAlgUEufXG31X9mBW5dh6Nvk9icnnw=";
    };
  ...
  CatalystViewCSV = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-vKcEaDzDXEevuJrDjHFRAu2+gIF57gcz0qDrMRojbN8=";
    };
  ...
  CGI = buildPerlPackage {
    ...
    version = "4.54";
    src = fetchurl {
      url = "mirror://cpan/authors/id/L/LE/LEEJO/CGI-4.54.tar.gz";
      sha256 = "sha256-lgigRK4uh8766OabET44KFUt2roNWWoC+ZVMasF/opQ=";
    };
  ...
  CGIFast = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-AiPX+RuAA3ud/183NgZAtx9dyNvZiaBZPV0i8/c8s9Q=";
    };
  ...
  ClassDataInheritable = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-RAiNbpBxLhh7ilsFDKWxxw7+K6oyrhI+m9j1nynwbk0=";
    };
  };
  ...
  Clipboard = buildPerlModule {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-no15AVGUJjNXwloPXQlIAP/0O9v5+GAew7DtXrCWbSY=";
    };
    meta = {
  ...
  CodeTidyAll = buildPerlPackage {
     ...
     version = "0.81";
     src = fetchurl {
       url = "mirror://cpan/authors/id/D/DR/DROLSKY/Code-TidyAll-0.81.tar.gz";
       sha256 = "sha256-TaxkFqMDXX4bE0WtBeJW1oJrRBlRb96wIe/8/UrVQA8=";
     };
  ...
  CompressRawBzip2 = buildPerlPackage {
    ...
    version = "2.103";
    src = fetchurl {
      url = "mirror://cpan/authors/id/P/PM/PMQS/Compress-Raw-Bzip2-2.103.tar.gz";
      sha256 = "sha256-YXLRaweXsQoU5+Ho393NPZiRCtz1aBKF5xZlnxGXFk0=";
    };
  ...
  CompressRawLzma = buildPerlPackage {
    ...
    version = "2.103";
    src = fetchurl {
      url = "mirror://cpan/authors/id/P/PM/PMQS/Compress-Raw-Lzma-2.103.tar.gz";
      sha256 = "sha256-iv0mk+mob/TnzwSQeZHUGFaXGPVR8H4VgDQUOYaHHdc=";
    };
    preConfigure = ''
      cat > config.in <<EOF
  ...
  ConfigMVP = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-2KYGm+MXqGbYBBsbt8+v40AU8ZdDiR8npeQqMbXA6nU=";
    };
    buildInputs = [ TestFatal ];
  ...
  ConfigTiny = buildPerlPackage {
    ...
    version = "2.28";
    src = fetchurl {
      url = "mirror://cpan/authors/id/R/RS/RSAVAGE/Config-Tiny-2.28.tgz";
      sha256 = "sha256-Et+EOg0p1I9hvMFMTxjwhY/Seo3YKaADGVKdZU/gFQA=";
    };
    buildInputs = [ TestPod ];
  };
  ...
  Connector = buildPerlPackage {
    ...
    version = "1.44";
    src = fetchurl {
      url = "mirror://cpan/authors/id/M/MR/MRSCOTTY/Connector-1.44.tar.gz";
      sha256 = "sha256-LQOFZBSSk8wnt8b6tJAoWQ9Q4KNCS++pib24UvAPhYs=";
    };
  ...
  curry = buildPerlPackage {
     ...
     src = fetchurl {
       ...
       sha256 = "sha256-yY/iBQ+t7KOYGdboDVROkSGE/oRsvnNTnGhpT7G1HAg=";
     };
     meta = {
  ...
  CPAN = buildPerlPackage {
    ...
    version = "2.33";
    src = fetchurl {
      url = "mirror://cpan/authors/id/A/AN/ANDK/CPAN-2.33.tar.gz";
      sha256 = "sha256-NxjZJ8KD0WfDkkAR4Fb9Jaosu2deqZgP4y3Z+7Ax0n0=";
    };
  ...
  CpanelJSONXS = buildPerlPackage {
    ...
    version = "4.27";
    src = fetchurl {
      url = "mirror://cpan/authors/id/R/RU/RURBAN/Cpanel-JSON-XS-4.27.tar.gz";
      sha256 = "sha256-OspbNGR5cmxW8Ze1yY/2A262RZAynQSA6zASDuqRBE4=";
    };
    meta = {
  ...
  CPANPerlReleases = buildPerlPackage {
    ...
    version = "5.20220320";
    src = fetchurl {
      url = "mirror://cpan/authors/id/B/BI/BINGOS/CPAN-Perl-Releases-5.20220320.tar.gz";
      sha256 = "sha256-dKgULR1wYhF5k6og3kETpueZrRoYBkle5Y9mM4ZuMHw=";
    };
    meta = {
  ...
  CPANPLUS = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-dsPl2mI6SvYP5krexEj7H44Mrp9nmKNraIZZdAROm2c=";
    };
  ...
  CPANUploader = buildPerlPackage {
    ...
    version = "0.103016";
    src = fetchurl {
      url = "mirror://cpan/authors/id/R/RJ/RJBS/CPAN-Uploader-0.103016.tar.gz";
      sha256 = "sha256-KRQZrWRz9A6LD76iEOaO6B+H7/dUNgKc2fCyRxzexN8=";
    };
  ...
  CryptFormat = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-p1cdS+9XeOGln0O2XPLVaAtJ+nu78z89IfRSL0Pmp9o=";
    };
  ...
  CryptOpenSSLGuess = buildPerlPackage {
     ...
     src = fetchurl {
       ...
       sha256 = "sha256-HFAzOBgZ/bTJCH3SkbkOxw54ENMdV+remziOzP1wOG0=";
     };
     meta = {
  ...
  CryptOpenSSLRSA = buildPerlPackage {
    ...
    version = "0.32";
    src = fetchurl {
      url = "mirror://cpan/authors/id/T/TO/TODDR/Crypt-OpenSSL-RSA-0.32.tar.gz";
      sha256 = "sha256-rcdPCuElx39l1d0yq7nDQpMAp5VDvyY0lPMz+cC2KmE=";
    };
    propagatedBuildInputs = [ CryptOpenSSLRandom ];
    NIX_CFLAGS_COMPILE = "-I${pkgs.openssl.dev}/include";
    NIX_CFLAGS_LINK = "-L${lib.getLib pkgs.openssl}/lib -lcrypto";
  ...
  CryptOpenSSLX509 = buildPerlPackage rec {
    ...
    version = "1.913";
    src = fetchurl {
      url = "mirror://cpan/authors/id/J/JO/JONASBN/Crypt-OpenSSL-X509-1.913.tar.gz";
      sha256 = "sha256-QGjtLKVG1qc3akkHyT+/7CRmvP8vMXKP3PAvaTFwC+c=";
    };
    NIX_CFLAGS_COMPILE = "-I${pkgs.openssl.dev}/include";
    NIX_CFLAGS_LINK = "-L${lib.getLib pkgs.openssl}/lib -lcrypto";
    meta = {
  ...
  CryptEd25519 = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-sdEaWU/rUeQG2BsUfcDRClV8z0yrgcDbP4mBAmd9JKg=";
    };
  ...
  CSSMinifierXS = buildPerlModule {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-xBnjCM3IKvHCXWuNB7L/JjR6Yit6Y+wghWq+jbQFH4I=";
    };
    perlPreHook = lib.optionalString (stdenv.isi686 || stdenv.isDarwin) "export LD=$CC";
    meta = {
  ...
  Curses = buildPerlPackage {
    ...
    version = "1.38";
    src = fetchurl {
      url = "mirror://cpan/authors/id/G/GI/GIRAFFED/Curses-1.38.tar.gz";
      sha256 = "sha256-1SFAgpjrZBOyCe8p1P/LpvX1juGrxgFgc5oXqvy48vI=";
    };
  ...
  DataUtil = buildPerlModule {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-tVypHHafgTN8xrCrIMMmg4eOWyZj8cwljFEamZpd/dM=";
    };
  ...
  DateManip = buildPerlPackage {
    ...
    version = "6.86";
    src = fetchurl {
      url = "mirror://cpan/authors/id/S/SB/SBECK/Date-Manip-6.86.tar.gz";
      sha256 = "sha256-tSA3gtA8eapYIs8z0YKKqjtNuTonXUpCjIn1b0cTNh8=";
    };
  ...
  DateTime = buildPerlPackage {
    ...
    version = "1.57";
    src = fetchurl {
      url = "mirror://cpan/authors/id/D/DR/DROLSKY/DateTime-1.57.tar.gz";
      sha256 = "sha256-hGQymaQPETNhoImOTmNmOKpddmh2AEejy7y8StV/2Gs=";
    };
  ...
  DateTimeFormatISO8601 = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-WChH9uApBlM0oAVk8gzXwo9OXNTsIVE9D2klMe07VuE=";
    };
  ...
  DateTimeFormatNatural = buildPerlModule {
    ...
    version = "1.13";
    src = fetchurl {
      url = "mirror://cpan/authors/id/S/SC/SCHUBIGER/DateTime-Format-Natural-1.13.tar.gz";
      sha256 = "sha256-iVjt/QPw9LbXvhIS9vZ1JQ6jffiZcawjdr5d3UTS8lY=";
    };
  ...
  DateTimeFormatStrptime = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-cB5GgCyG7U2IaVwabay76QszkL7reU84fnx5IwADdXk=";
    };
    buildInputs = [ TestFatal TestWarnings ];
    propagatedBuildInputs = [ DateTime ];
    meta = {
  ...
  DateTimeFormatW3CDTF = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-3MIAoHOiHLpIEipdrgtqh135PT+MiunURtzdm++qQTo=";
    };
    propagatedBuildInputs = [ DateTime ];
    meta = {
  ...
  DateTimeTimeZone = buildPerlPackage {
    ...
    version = "2.52";
    src = fetchurl {
      url = "mirror://cpan/authors/id/D/DR/DROLSKY/DateTime-TimeZone-2.52.tar.gz";
      sha256 = "sha256-i8XEIIKHSw6cnvlJ+hkDWsm2kE682hkxqi2KE/OVDY8=";
    };
  ...
  DevelCheckOS = buildPerlPackage {
    ...
    version = "1.87";
    src = fetchurl {
      url = "mirror://cpan/authors/id/D/DC/DCANTRELL/Devel-CheckOS-1.87.tar.gz";
      sha256 = "sha256-nNpDmQRPwRFQyuuSwsaKikuMVDcLO89llDss0f1kgzE=";
    };
  ...
  DevelPPPort = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-UpDVu4TN6enmEROiDGe11HJn645loRmookjMlqrAuts=";
    };
    meta = {
  ...
  DBDMock = buildPerlModule {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-ClqllTq2XPeQaB5sBFLjGK1X2ArCf1dfhJGMYDqkdAY=";
    };
  ...
  DBDPg = buildPerlPackage {
    ...
    src = fetchurl {
      url = "mirror://cpan/authors/id/T/TU/TURNSTEP/DBD-Pg-3.15.1.tar.gz";
      sha256 = "sha256-E8dUO1RcmlJTyGVQzNkgTQb+XzSn3FF2nT3WZVY/wX4=";
    };
  ...
  DBDsybase = buildPerlPackage {
    ...
    src = fetchurl {
      url = "mirror://cpan/authors/id/M/ME/MEWP/DBD-Sybase-1.19.tar.gz";
      sha256 = "sha256-Hu6oPFBdCn+QC5UrZgKuM9Fk/XIB0cmo3Mxzu4xqhYU=";
    };
  ...
  DBFile = buildPerlPackage {
    ...
    src = fetchurl {
      url = "mirror://cpan/authors/id/P/PM/PMQS/DB_File-1.857.tar.gz";
      sha256 = "sha256-dSjq7knM094mjZNYImxsdhfQ19h4b8wx10AsVNVwo5Q=";
    };
  ...
  DBIxSearchBuilder = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-5C/dpvbmSSe7h3dIPlZtaDA6iwkY0YjKD+VRo6PUQr0=";
    };
  ...
  DevelHide = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-/I2+t/fXWnjtSWseDgXPyZxorKs6LpLP8VXKXw+l31g=";
    };
  };
  ...
  DigestCRC = buildPerlPackage {
    ...
    version = "0.23";
    src = fetchurl {
      url = "mirror://cpan/authors/id/O/OL/OLIMAUL/Digest-CRC-0.23.tar.gz";
      sha256 = "sha256-oUhSjhmnyLo/7COngVASER9HVOlBuddnlDJw2KXFxNg=";
    };
    meta = {
  ...
  DigestHMAC = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-1ryBVqonXETXlLfBj0TNrEpYFAJFyVnmsZssODiwjtQ=";
    };
    meta = {
...
#    buildInputs = [ TestPodLinkCheck ];
  ...
  EmailOutlookMessage = buildPerlModule {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-+0q+6hTNpRweYLwhHPlSG7uq50uEEYym1Y8KciNoA4g=";
    };
  ...
  Encode = buildPerlPackage {
    ...
    version = "3.17";
    src = fetchurl {
      url = "mirror://cpan/authors/id/D/DA/DANKOGAI/Encode-3.17.tar.gz";
      sha256 = "sha256-tEy/fdYOxhKOxXXdNISEl1CGUiYRvHWAz9MFoJX6ptI=";
    };
    meta = {
  ...
  ExtUtilsCBuilder = buildPerlPackage {
    ...
    version = "0.280236";
    src = fetchurl {
      url = "mirror://cpan/authors/id/A/AM/AMBS/ExtUtils-CBuilder-0.280236.tar.gz";
      sha256 = "sha256-q8IYJ+uKUTFxv3/ezvzplFEyy3bblFA2UYKR9gexSR8=";
    };
    meta = {
  ...
  ExtUtilsMakeMaker = buildPerlPackage {
    ...
    version = "7.64";
    src = fetchurl {
      url = "mirror://cpan/authors/id/B/BI/BINGOS/ExtUtils-MakeMaker-7.64.tar.gz";
      sha256 = "sha256-SmrFdYFcBBOx9YlnBDzJ8uFmRGtzxof5vGK16u2UZKA=";
    };
    meta = {
  ...
  FileBaseDir = buildPerlModule {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-bab3KBVirI8R7xo69q7bUcQRgrYPHxIs7QB579kpZ9k=";
    };
    configurePhase = ''
  ...
  FileFindObject = buildPerlModule {
    ...
    version = "0.3.6";
    src = fetchurl {
      url = "mirror://cpan/authors/id/S/SH/SHLOMIF/File-Find-Object-0.3.6.tar.gz";
      sha256 = "sha256-GueX0SNIkg2LsN0AMKlqpSNShaleND6O2HN+76xTVpU=";
    };
  ...
  FileFindObjectRule = buildPerlModule {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-gZQPKZ1khySPvzDY8ft99sajSz35RApWIbE1yONPz/I=";
    };
  ...
  FileLoadLines = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-mOQS98aSYRNPNLh4W926sxVrj0UlU9u1tWytaDuG//A=";
    };
    buildInputs = [ TestException ];
    meta = {
  ...
  FutureAsyncAwait = buildPerlModule rec {
    ...
    version = "0.57";
    src = fetchurl {
      url = "mirror://cpan/authors/id/P/PE/PEVANS/Future-AsyncAwait-0.57.tar.gz";
      sha256 = "sha256-Wd+WLpyu/9dH6j1rhE+w1/lWvS68KbkzZ/4o4nOEYg==";
    };
  ...
  GetoptLongDescriptive = buildPerlPackage {
    ...
    version = "0.110";
    src = fetchurl {
      url = "mirror://cpan/authors/id/R/RJ/RJBS/Getopt-Long-Descriptive-0.110.tar.gz";
      sha256 = "sha256-AlQCwElKXIeAOPBmb0HKEjDtDWiUZ9+SETgv86NVvoY=";
    };
    buildInputs = [ CPANMetaCheck TestFatal TestWarnings ];
  ...
  Gnome2 = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-ZPzDgnFKvY1XaSrDdjKMOiDGy8i81zKwB9FMv5ooLd0=";
    };
  ...
  Gnome2Canvas = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-aQZnxziSHeLWUWtOtjlVOlceSoMQ2AMfFYZYU23lq0I=";
    };
  ...
  Gnome2Wnck = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-RL7OyLLX9B8ngKc7CSJp/bec1JJluuDI/zkQN8RWSjU=";
    };
  ...
  GnuPGInterface = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-wnpIw9SOGpIF42Lu6mbUawMr2EY3mR/fCxOCi8r90+Y=";
    };
  ...
  Graph = buildPerlPackage {
    ...
    version = "0.9725";
    src = fetchurl {
      url = "mirror://cpan/authors/id/E/ET/ETJ/Graph-0.9725.tar.gz";
      sha256 = "sha256-51sOzJp/Yv1w+Jaxc9EcP8AM3/01w+mShmidPKLevv4=";
    };
  ...
  Gtk2TrayIcon = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-OfwrmabmE9qeqXfYy1MD+l4H5poVJIk03hIXqXuWRVQ=";
    };
  ...
  Gtk2Unique = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-nOX2ikFgC8z31u/eMMBwqxFOk57XqKx8O3rZE5mJGGc=";
    };
  ...
  HTMLEscape = buildPerlModule {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-Wl7viWUA0epsJKkIXs++mkOr7mjPxmwD+InSostoml0=";
    };
  ...
  HTMLParser = buildPerlPackage {
    ...
    version = "3.78";
    src = fetchurl {
      url = "mirror://cpan/authors/id/O/OA/OALDERS/HTML-Parser-3.78.tar.gz";
      sha256 = "sha256-IlZAAvIGr5TB3YU18CsNlzUSXZ6+id0P+c1sAA4pwp0=";
    };
  ...
  HTTPCookies = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-4282Yzxc5rXkuHb/z3R4fMXv4HNt1/SHvdc8FPC9cAc=";
    };
    propagatedBuildInputs = [ HTTPMessage ];
    meta = {
  ...
  HTTPMessage = buildPerlPackage {
    ...
    version = "6.36";
    src = fetchurl {
      url = "mirror://cpan/authors/id/O/OA/OALDERS/HTTP-Message-6.36.tar.gz";
      sha256 = "sha256-V2pTtIavh9tWJho2CZd2NwwG8Ah9F5/Ix7uAO0jN3XY=";
    };
    buildInputs = [ TryTiny ];
  ...
  IO = buildPerlPackage {
    ...
    version = "1.48";
    src = fetchurl {
      url = "mirror://cpan/authors/id/T/TO/TODDR/IO-1.48.tar.gz";
      sha256 = "sha256-wnG1GOKLqbyVvAgktonbjjUAYhnrLAPx7Dlb0IklNlg=";
    };
    doCheck = false;
    meta = {
  ...
  IOAIO = buildPerlPackage {
    ...
    version = "4.76";
    src = fetchurl {
      url = "mirror://cpan/authors/id/M/ML/MLEHMANN/IO-AIO-4.76.tar.gz";
      sha256 = "sha256-OfUESpPOIRS5CK/nekYViBo9eKDtU+RQJwjdXUMzII8=";
    };
    buildInputs = [ CanaryStability ];
    propagatedBuildInputs = [ commonsense ];
    nativeBuildInputs = lib.optional stdenv.isDarwin shortenPerlShebang;
  ...
  IOCompress = buildPerlPackage {
    ...
    version = "2.104";
    src = fetchurl {
      url = "mirror://cpan/authors/id/P/PM/PMQS/IO-Compress-2.104.tar.gz";
      sha256 = "sha256-6H2Q08b9emZ7Kk/su14dIHTaihG4tsqyC+Ee07HRmBg=";
    };
  ...
  JavaScriptMinifierXS = buildPerlModule {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-XZsDT1jwtv9bZGR708WpzgWypw7e4zn7wxc67nR8wFA=";
    };
    perlPreHook = lib.optionalString (stdenv.isi686 || stdenv.isDarwin) "export LD=$CC";
    meta = {
  ...
  JSONPP = buildPerlPackage {
    ...
    version = "4.07";
    src = fetchurl {
      url = "mirror://cpan/authors/id/I/IS/ISHIGAKI/JSON-PP-4.07.tar.gz";
      sha256 = "sha256-e62/WQqbIWYV1u9Iebz5xsJy1gTN+fdfC9VqJrQlK9U=";
    };
    meta = {
 ...
 JSONWebToken = buildPerlModule {
  ...
  ListAllUtils = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-MKgUarIad4e4xW1YKc+afysVJ207P8oHM2rDjTAC/7w=";
    };
  ...
  LogAny = buildPerlPackage {
    ...
    version = "1.710";
    src = fetchurl {
      url = "mirror://cpan/authors/id/P/PR/PREACTION/Log-Any-1.710.tar.gz";
      sha256 = "sha256-vbZf0KiIj9RSLznw/pXpTLkmfvH9n3c3Vk1GUnswb28=";
    };
    # Syslog test fails.
  ...
  Logger = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-YI35Dcwl1PIDCUYasfIuCPVljAbxLEKaQkQm4Klab5o=";
    };
    meta = {
  ...
  MCE = buildPerlPackage {
     ...
     version = "1.878";
     src = fetchurl {
       url = "mirror://cpan/authors/id/M/MA/MARIOROY/MCE-1.878.tar.gz";
       sha256 = "sha256-u1cTGXzFq5EwKux0a1zHIEv4RVbDDWr2fONKb9OERK0=";
     };
     meta = {
  ...
  LogLog4perl = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-u6vkLTtM2qOkdma5V76B1Vu9HLz/zf8rEZWG0zYC6r4=";
    };
    meta = {
  ...
  LogDispatchouli = buildPerlPackage {
    ...
    version = "2.023";
    src = fetchurl {
      url = "mirror://cpan/authors/id/R/RJ/RJBS/Log-Dispatchouli-2.023.tar.gz";
      sha256 = "sha256-xKxBuXKbcUOWgrNN0ncrBAta254aYR0wMiwB9GCODPI=";
    };
    buildInputs = [ TestDeep TestFatal ];
  ...
  LWP = buildPerlPackage {
    ...
    version = "6.62";
    src = fetchurl {
      url = "mirror://cpan/authors/id/O/OA/OALDERS/libwww-perl-6.62.tar.gz";
      sha256 = "sha256-VprBXradVLKo2TJANhBpC4nGjWqYfqsvYnwGObrn3hg=";
    };
  ...
  MacPasteboard = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-L16N0tsNZEVVhITKbULYOcWpfuiqGyUOaU1n1bf2Y0w=";
    };
    meta = with lib; {
  ...
  MailAuthenticationResults = buildPerlPackage {
    ...
    version = "2.20210915";
    src = fetchurl {
      url = "mirror://cpan/authors/id/M/MB/MBRADSHAW/Mail-AuthenticationResults-2.20210915.tar.gz";
      sha256 = "sha256-wpe8m7GvKjcgHbmSDhy14vWBAkcT9cWxNfQUAuyU4Q8=";
    };
    buildInputs = [ TestException ];
    meta = {
  ...
  MailMessage = buildPerlPackage {
     ...
     version = "3.012";
     src = fetchurl {
       url = "mirror://cpan/authors/id/M/MA/MARKOV/Mail-Message-3.012.tar.gz";
       sha256 = "sha256-6SsAIODLEcypL5PfndMkQdeLhKPEtyCUwKcDECU8rJ4=";
     };
  ...
  MailDKIM = buildPerlPackage {
    ...
    version = "1.20220408";
    src = fetchurl {
      url = "mirror://cpan/authors/id/M/MB/MBRADSHAW/Mail-DKIM-1.20220408.tar.gz";
      sha256 = "sha256-LV/q+IVf9RIj/3yKmpt2VxE85ghuplcI2SJVHeSNQ2k=";
    };
  ...
  MathBigIntGMP = buildPerlPackage {
    ...
    version = "1.6010";
    src = fetchurl {
      url = "mirror://cpan/authors/id/P/PJ/PJACKLAM/Math-BigInt-GMP-1.6010.tar.gz";
      sha256 = "sha256-ViZqOX5zNaYKJ/yFaEypcQp/E5ajwu+Ubl/4kYklIKg=";
    };
  ...
  MathProvablePrime = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-D7YWRJ+weorR6KgJxwghthjlPcD/3ayWVnYY3jPEbBE=";
    };
  ...
  MIMELite = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-eKJ58dLiQlUcNH75ehP8Z1dmYCy4TCqAxWlAD082i6s=";
    };
    propagatedBuildInputs = [ EmailDateFormat ];
    meta = {
  ...
  ModuleScanDeps = buildPerlPackage {
    ...
    version = "1.31";
    src = fetchurl {
      url = "mirror://cpan/authors/id/R/RS/RSCHUPP/Module-ScanDeps-1.31.tar.gz";
      sha256 = "sha256-/E2Y0rABV0XztVtR3fREWnOwaa0Mt+w22Op4HWEHTZ0=";
    };
    buildInputs = [ TestRequires ];
    meta = {
  ...
  Mojolicious = buildPerlPackage {
    ...
    version = "9.23";
    src = fetchurl {
      url = "mirror://cpan/authors/id/S/SR/SRI/Mojolicious-9.23.tar.gz";
      sha256 = "sha256-8/YYxwDhgUTnxSnF5hzSo3xA/QJceTWOWeXpw/4BKsY=";
    };
    meta = {
  ...
  MojoSQLite = buildPerlModule {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-Vzmprz/A/BYrOAMt9hCgcANSY7++C+wWrsUvDd3Xtkc=";
    };
    buildInputs = [ ModuleBuildTiny ];
  ...
  MojoUserAgentCached = buildPerlPackage {
    ...
    version = "1.18";
    src = fetchurl {
      url = "mirror://cpan/authors/id/N/NI/NICOMEN/Mojo-UserAgent-Cached-1.18.tar.gz";
      sha256 = "sha256-3Du3Njm30gVtgeKXSa8mRg07iIERQrrXxEAKjnfRfLI=";
    };
  ...
  Moose = buildPerlPackage {
    ...
    version = "2.2201";
    src = fetchurl {
      url = "mirror://cpan/authors/id/E/ET/ETHER/Moose-2.2201.tar.gz";
      sha256 = "sha256-zV/5tHUfc+y2h0updhND01c31N31/2sZwA0Br1/8PrI=";
    };
  ...
  MooseXAppCmd = buildPerlModule {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-9eLy7xKcOI8qPjb1PeWYBErxtyLofXEFKdBcwl0jesI=";
    };
  ...
  MooseXGetopt = buildPerlModule {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-Y/O+W7K8OB6eSLW5XAMw8hcYtmVuj/sZyZ0u4KwU68g=";
    };
  ...
  MooseXTypesURI = buildPerlModule {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-Jxd1Ta25EIbhHSH+oGy6qaEuYBtB0VRDFQ7dfZUI7+g=";
    };
    buildInputs = [ ModuleBuildTiny TestSimple13 ];
  ...
  MozillaCA = buildPerlPackage {
    ...
    version = "20211001";
    src = fetchurl {
      url = "mirror://cpan/authors/id/A/AB/ABH/Mozilla-CA-20211001.tar.gz";
      sha256 = "sha256-EiyJAAAKnTiKqORPkRyrbBGP6El0F5F6hKjsGDlxtEk=";
    };
  ...
  NetAmazonS3 = buildPerlPackage {
    ...
    version = "0.99";
    src = fetchurl {
      url = "mirror://cpan/authors/id/B/BA/BARNEY/Net-Amazon-S3-0.99.tar.gz";
      sha256 = "sha256-Fp1e/PmtZCrU5ZnPwmyl5WBChkhGhaDutXhGmJTquR8=";
    };
  ...
  NetHTTP = buildPerlPackage {
    ...
    version = "6.22";
    src = fetchurl {
      url = "mirror://cpan/authors/id/O/OA/OALDERS/Net-HTTP-6.22.tar.gz";
      sha256 = "sha256-Yvr5pbhCNUQ/4Y94DmnOzwV96j3icdfYoLpyckRYoaI=";
    };
    propagatedBuildInputs = [ URI ];
  ...
  NetIPv6Addr = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-sjQBwSJv7o3+Yn9a4OkMVaxUcBDso5gRDcFjH0HJ7H0=";
    };
  ...
  NetSFTPForeign = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-bH1kJQh2hz2kNIAOUGCovvekZFHYH4F+N+Q8/aUaD3o=";
    };
    propagatedBuildInputs = [ pkgs.openssl ];
    patchPhase = ''
  ...
  NetTelnet = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-Z39ouizSqCT64yP6guGDv349A8PEmckdkjvWKDeWp0M=";
    };
    meta = {
  ...
  NetOpenSSH = buildPerlPackage {
    ...
    version = "0.82";
    src = fetchurl {
      url = "mirror://cpan/authors/id/S/SA/SALVA/Net-OpenSSH-0.82.tar.gz";
      sha256 = "sha256-1BqiTdU0ZnUyCfWmfGOS5vP6WZcJFpNCy8xfSHHZfoM=";
    };
    meta = {
  ...
  PathTiny = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-S8b3bQVIzNizjLZikaiFvw3kU9AWdWLHuC6IYa/c+3w=";
    };
    meta = {
  ...
  PDFAPI2 = buildPerlPackage {
    ...
    version = "2.043";
    src = fetchurl {
      url = "mirror://cpan/authors/id/S/SS/SSIMMS/PDF-API2-2.043.tar.gz";
      sha256 = "sha256-YxL2BRcpc/pNAXY5whe2GxqNbFMyN85Y1arOz6Jz8LI=";
    };
  ...
  PerlCriticCommunity = buildPerlModule {
    ...
    version = "1.0.2";
    src = fetchurl {
      url = "mirror://cpan/authors/id/D/DB/DBOOK/Perl-Critic-Community-v1.0.2.tar.gz";
      sha256 = "sha256-rr5lIDjyucQT6gsgh63IndLompTItGQMDZt8g7w01t0=";
    };
    buildInputs = [ ModuleBuildTiny ];
  ...
  perlldap = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-4vOJ/j56nkthSIaSkZrXI7mPO0ebUoj2ENqownmVs1E=";
    };
  ...
  POE = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-V94rY1sV+joxqeVd1REiFJ5UFOEVjugiNQYmNO4YppM=";
    };
  ...
  PPIxQuoteLike = buildPerlModule {
    ...
    version = "0.021";
    src = fetchurl {
      url = "mirror://cpan/authors/id/W/WY/WYANT/PPIx-QuoteLike-0.021.tar.gz";
      sha256 = "sha256-Hr8iPq6Z20IoGoNOoNS2qVudQZK/lPpKxqalwApc/2c=";
    };
  ...
  PPIxRegexp = buildPerlModule {
    ...
    version = "0.084";
    src = fetchurl {
      url = "mirror://cpan/authors/id/W/WY/WYANT/PPIx-Regexp-0.084.tar.gz";
      sha256 = "sha256-SvWTDm6TNgHf4VCzR8Vai0IBUWCQFsFA0ic08whTnYM=";
    };
  ...
  PerlPrereqScannerNotQuiteLite = buildPerlPackage {
    ...
    version = "0.9916";
    src = fetchurl {
      url = "mirror://cpan/authors/id/I/IS/ISHIGAKI/Perl-PrereqScanner-NotQuiteLite-0.9916.tar.gz";
      sha256 = "sha256-Z6lxBg4S2wzSQqiAuoN0uXBg4xOKN/OaeOOMCdvuVUk=";
    };
  ...
  PodEventual = buildPerlPackage {
    ...
    version = "0.094002";
    src = fetchurl {
      url = "mirror://cpan/authors/id/R/RJ/RJBS/Pod-Eventual-0.094002.tar.gz";
      sha256 = "sha256-gBlPP+Zt2L2RKC6zYQ9cfKyNxaDNUagcTVap7Bj+orw=";
    };
    propagatedBuildInputs = [ MixinLinewise ];
    meta = {
  ...
  PodStrip = buildPerlModule {
     ...
     src = fetchurl {
       ...
       sha256 = "sha256-Z1BqZh+pyuzv57pPQvC8FbCm8JZ8eWB3QPbLaXSu1M0=";
     };
     meta = {
  ...
  RoleTiny = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-173unhOKT4OqUtCpgWJWRL2of/FmQt+oRdy0TZokK0U=";
    };
    meta = {
  ...
  ScalarListUtils = buildPerlPackage {
    ...
    version = "1.62";
    src = fetchurl {
      url = "mirror://cpan/authors/id/P/PE/PEVANS/Scalar-List-Utils-1.62.tar.gz";
      sha256 = "sha256-cnnE7H3wzywKy4dKvf6GlW9QKNJBSXTbVu377YpNM58=";
    };
    meta = {
  ...
  SerealEncoder = buildPerlPackage {
    ...
    version = "4.023";
    src = fetchurl {
      url = "mirror://cpan/authors/id/Y/YV/YVES/Sereal-Encoder-4.023.tar.gz";
      sha256 = "sha256-uHdfsvvpT99SNe87X+8s5FLL5sOor0Icf1aotV3aWhE=";
    };
  ...
  SetObject = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-0YxaiiM+q70CBs89pbAPzdezf+vxKpPcw9HAJub97EU=";
    };
    meta = {
  ...
  Specio = buildPerlPackage {
     ...
     src = fetchurl {
       ...
       sha256 = "sha256-9BMH8URE+Hd+Vy8n7rapZAhDmefjgsR8V3gnrYooahw=";
     };
  ...
  StringCRC32 = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-lwYJOy0Gi2cV01tMWPUVWON5YAgyAhKfuwClfhmnRxM=";
    };
  };
  ...
  StringRandom = buildPerlModule {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-nZPGeaNP+ibTtPoIN8rtHNLmfXZXKBi5HpfepzRwUkY=";
    };
  };
  ...
  TemplateTiny = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-gZz6tgREg8/ijOsof938MXaiAlsbbw6YCy3MJtImm0w=";
    };
    meta = {
  ...
  TermShell = buildPerlModule {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-U6C9smVokcUIpHDZPLfhz+qzjuqeWClWCn2LX2APa/I=";
    };
  ...
  TermTable = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-j7T7uOlqLWxRSUnrjP1+ZjGbyxy/fOoKsZr4h6ctl78=";
    };
    propagatedBuildInputs = [ Importer ];
    meta = {
  ...
  Test2Suite = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-7US+c5yIef4XjTEHsjjy25YNUnl9sAWN5TvluEYANYs=";
    };
  ...
  TestClass = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-QMGx04jwqGdHacJ1KfDMNjTKD9nY9ysZbAUxYRk0vII=";
    };
    buildInputs = [ TestException ];
  ...
  TestCompile = buildPerlModule {
    ...
    version = "3.0.1";
    src = fetchurl {
      url = "mirror://cpan/authors/id/E/EG/EGILES/Test-Compile-v3.0.1.tar.gz";
      sha256 = "sha256-niCY0yH7Rv5xPHG1wh+aCMlmJRQnFZQ+a9cS0RGaBnc=";
    };
    propagatedBuildInputs = [ UNIVERSALrequire ];
    meta = {
  ...
  TestFile = buildPerlPackage {
    ...
    version = "1.992";
    src = fetchurl {
      url = "mirror://cpan/authors/id/B/BD/BDFOY/Test-File-1.992.tar.gz";
      sha256 = "sha256-d8V8R6QN8R5V0yZGCHA6eVc/kJtvmJ7xodF/kWVoD3c=";
    };
    buildInputs = [ Testutf8 ];
    meta = {
  ...
  TestMockModule = buildPerlModule {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-G9p6SdzqdgdtQKe2psPz4V5rGchLYXHfRFNNkROPEEU=";
    };
  ...
  TestScript = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-iS5+bB6nsWcQkJlCz1wL2rcO7i79SqnBbqlS4rkPiVA=";
    };
  ...
  TestSimple13 = buildPerlPackage {
    ...
    version = "1.302190";
    src = fetchurl {
      url = "mirror://cpan/authors/id/E/EX/EXODIST/Test-Simple-1.302190.tar.gz";
      sha256 = "sha256-+7FSJvHGBcRGaoxroCAwCD1UMz00+nbAJUnK5wFMOg4=";
    };
    meta = {
  ...
  TestSynopsis = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-0mjJizPS+hTbsisg1lYbq0ie6CWH374ZrSd2IMe4tt4=";
    };
    meta = {
  ...
  TestTrailingSpace = buildPerlModule {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-q7jOdEg6Y9c/4e9gO3zgptR8mO3nMZVdc1eE+tHcT8w=";
    };
  ...
  TestWarnings = buildPerlPackage {
    ...
    version = "0.031";
    src = fetchurl {
      url = "mirror://cpan/authors/id/E/ET/ETHER/Test-Warnings-0.031.tar.gz";
      sha256 = "sha256-HlQpCf7zBeRVY+mHjqHDsMfO8bKLt64H66Lh76vsR3s=";
    };
  ...
  TextCSV_XS = buildPerlPackage {
    ...
    version = "1.47";
    src = fetchurl {
      url = "mirror://cpan/authors/id/H/HM/HMBRAND/Text-CSV_XS-1.47.tgz";
      sha256 = "sha256-S7r/vftoUF7zMm3HSOY+vg2zEVe3jKjfy4w80dExMmI=";
    };
    meta = {
  ...
  TestManifest = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-0k5SVT58uc2oH5L/6MkrPkNGcY5HEIAaWzW38lGnceI=";
    };
    meta = {
  ...
  TextTemplate = buildPerlPackage {
    ...
    version = "1.60";
    src = fetchurl {
      url = "mirror://cpan/authors/id/M/MS/MSCHOUT/Text-Template-1.60.tar.gz";
      sha256 = "sha256-2dV/s/QytPEA5s6wbINju67grYXVPXKPa6FaMwJIUBw=";
    };
  ...
  TextTrim = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-1YeKkHnTPNF2bParxEzWJb0AoCE9LOjjFD/mlEq6qhE=";
    };
    meta = {
  ...
  TimeDurationParse = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-EISmRj7ieQ+ZIVvXaxNcpFr+K/ppmPpv1UcLaeG6vBI=";
    };
  ...
  Tk = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-Mqpycaa9/twzMBGbOCXa3dCqS1yTb4StdOq7kyogCl4=";
    };
  ...
  TreeSimple = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-t+l5m9Iiu5TP+ZP312WYDL6hts0qql7L6tY1q99H0pw=";
    };
    buildInputs = [ TestException ];
    meta = {
  ...
  TreeSimpleVisitorFactory = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-nPU4+qEsVP+0qRQ5lF5IjxhW9iuJrFByqSIRngGIDaY=";
    };
  ...
  TryTiny = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-MwDTHYpAdbJtj0bOhkodkT4OhGfO66ZlXV0rLiBsEb4=";
    };
  ...
  Twiggy = buildPerlPackage {
     ...
     src = fetchurl {
       ...
       sha256 = "sha256-TZHqbtmumo70MU3Cp89S6wJrNlvmg4azXqaGTfrFf54=";
     };
  ...
  TypeTiny = buildPerlPackage {
    ...
    version = "1.012004";
    src = fetchurl {
      url = "mirror://cpan/authors/id/T/TO/TOBYINK/Type-Tiny-1.012004.tar.gz";
      sha256 = "sha256-dc0GthLRgwrp9LIimLUGs/8EUY+nRT9IfCSM1iqQais=";
    };
    propagatedBuildInputs = [ ExporterTiny ];
    meta = {
  ...
  UserIdentity = buildPerlPackage {
     ...
     version = "1.01";
     src = fetchurl {
       url = "mirror://cpan/authors/id/M/MA/MARKOV/User-Identity-1.01.tar.gz";
       sha256 = "sha256-7ACIoYjGq/sxaU/k1ce84MQt4MyiKK5+K90r/P4vrQ0=";
     };
     meta = {
  ...
  URIcpan = buildPerlPackage {
    ...
    version = "1.008";
    src = fetchurl {
      url = "mirror://cpan/authors/id/R/RJ/RJBS/URI-cpan-1.008.tar.gz";
      sha256 = "sha256-oU8ij0NbDkGLvWSq6v/ehJ19QwMEc49C8i9ETiZ7xhk=";
    };
  ...
  Version = buildPerlPackage {
    ...
    version = "0.9929";
    src = fetchurl {
      url = "mirror://cpan/authors/id/L/LE/LEONT/version-0.9929.tar.gz";
      sha256 = "sha256-UFbtSBraTg+klwltQJGxhljyFNhi4e0WTt8QvGs5yLA=";
    };
    meta = {
  ...
  vidir = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-GSKQdqXxPvGe1sEbu5Bcrc4iYH+pDoXJrxqqKbWsFQo=";
    };
    outputs = [ "out" ];
    meta = {
  ...
  WWWMechanize = buildPerlPackage {
    ...
    version = "2.06";
    src = fetchurl {
      url = "mirror://cpan/authors/id/O/OA/OALDERS/WWW-Mechanize-2.06.tar.gz";
      sha256 = "sha256-2XzTHjX9H/cHjT9Wi2Lj/jkRhDpk08LQeO69P/m4s40=";
    };
  ...
  Workflow = buildPerlModule {
    ...
    version = "1.60";
    src = fetchurl {
      url = "mirror://cpan/authors/id/J/JO/JONASBN/Workflow-1.60.tar.gz";
      sha256 = "sha256-oBbUasrjcot48EyEZnBQTkCfDRCfQCAQWvcvnaQ0X/I=";
    };
  ...
  YAMLPP = buildPerlPackage {
    ...
    version = "0.032";
    src = fetchurl {
      url = "mirror://cpan/authors/id/T/TI/TINITA/YAML-PP-0.032.tar.gz";
      sha256 = "sha256-J90LHjnO89ErtaB7KEHFWEhKmkMMSdPG+a4uYGWr2pA=";
    };
