...
let
  ...
  */
  ...
  CPANPerlReleases = buildPerlPackage {
    ...
    version = "5.20210109";
    src = fetchurl {
      url = "mirror://cpan/authors/id/B/BI/BINGOS/CPAN-Perl-Releases-5.20210109.tar.gz";
      sha256 = "1ii99w9ysm8jyq98y9vr56vg6szb8rvqjb8qxikprjyj0b64k7qm";
    };
    meta = {
  ...
  CSSMinifierXS = buildPerlModule {
    ...
    version = "0.11";
    src = fetchurl {
      url = "mirror://cpan/authors/id/G/GT/GTERMARS/CSS-Minifier-XS-0.11.tar.gz";
      sha256 = "01skcsdwbj55p2c4zdfmhn2xxc3dnq9mpw6f5c76vr93ablfazd5";
    };
    perlPreHook = lib.optionalString (stdenv.isi686 || stdenv.isDarwin) "export LD=$CC";
    meta = {
  ...
  DateTimeTimeZone = buildPerlPackage {
    ...
    version = "2.46";
    src = fetchurl {
      url = "mirror://cpan/authors/id/D/DR/DROLSKY/DateTime-TimeZone-2.46.tar.gz";
      sha256 = "1cx3axqi930haqpcz4nyknn07fl447a5iix19vg89w8pgq4rxhgl";
    };
...
#    buildInputs = [ TestPodLinkCheck ];
  ...
  Graph = buildPerlPackage {
    ...
    version = "0.9716";
    src = fetchurl {
      url = "mirror://cpan/authors/id/E/ET/ETJ/Graph-0.9716.tar.gz";
      sha256 = "19w6g6wjcw5ys368jn7k1lm0w39pdlay9js19n8npvxhx3908q3a";
    };
  ...
  JSONParse = buildPerlPackage {
    ...
    version = "0.59";
    src = fetchurl {
      url = "mirror://cpan/authors/id/B/BK/BKB/JSON-Parse-0.59.tar.gz";
      sha256 = "1j7l4si0y4bv9yjf53m60sa5j2a8pdfmyrkx14vdm9bpr2qdwzib";
    };
    meta = {
 ...
 JSONWebToken = buildPerlModule {
  ...
  Mojolicious = buildPerlPackage {
    ...
    version = "8.70";
    src = fetchurl {
      url = "mirror://cpan/authors/id/S/SR/SRI/Mojolicious-8.70.tar.gz";
      sha256 = "1jvpdhh0qx58h0a2hwvm59qxx338ia5acm7rvcfm4mlwqkf6y63b";
    };
    meta = {
  ...
  MojoPg = buildPerlPackage {
    ...
    version = "4.23";
    src = fetchurl {
      url = "mirror://cpan/authors/id/S/SR/SRI/Mojo-Pg-4.23.tar.gz";
      sha256 = "12xh7a8fgpnsd7y46k714cdn792zy1b3gnwyp43mkikm9wm0bmbk";
    };
  ...
  RoleTiny = buildPerlPackage {
    ...
    version = "2.002003";
    src = fetchurl {
      url = "mirror://cpan/authors/id/H/HA/HAARG/Role-Tiny-2.002003.tar.gz";
      sha256 = "12dv1zxnxar2ng536cvmlflj4as6v9wdd681hibx3pmys3rfb0b9";
    };
    meta = {
